...
<head>
    ...
    <title>TAMS || Appointments Form</title>
    <!-- Bootstrap -->
                ...
                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <p> Book your appointment to save tattoo rush.</p>
                            <form method="post">
                                <div class="row">
                                    <div class="col-md-6">
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                        <div class="footer-widget">
                            <h2 class="widget-title">Tattoo Shop Address</h2>
                            <ul class="listnone contact">
                                <li><i class="fa fa-map-marker"></i> Thamel Kathmandu </li>
                                <li><i class="fa fa-phone"></i> 1234567890</li>
                                <li><i class="fa fa-fax"></i> 1234567890</li>
                                <li><i class="fa fa-envelope-o"></i> govindaupta@gmail.com</li>
                            </ul>
                        </div>
                    </div>
